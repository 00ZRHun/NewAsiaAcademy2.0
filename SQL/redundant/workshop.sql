...
CREATE TABLE `workshop` (
  ...
  `ori price` int(9) NOT NULL,
  `off price` int(9) NOT NULL,
...
INSERT INTO `workshop` (`ID`, `title`, `image`, `details`, `upload_time`, `last_modified_time`, `delmode`) VALUES
