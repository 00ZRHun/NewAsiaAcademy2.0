<div class="right_col" role="main">            
    <div class="x_title">
      ...
      <ul class="nav navbar-right panel_toolbox">
        ...
        <button type="button" class="btn btn-success"> <a style="color: white" href="<?= site_url(); ?>Admin/Short_Course/" >Back</a></button>
      </ul>
      <div class="clearfix"></div>
    </div>
     
    <form method="POST" id="short_course_edit" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
      <?php 
        foreach($short_course_data as $row_short_course_data){ 
          $title=$row_short_course_data->title;
          $image=$row_short_course_data->image;
          $ori_price=$row_short_course_data->ori_price;
          $off_price=$row_short_course_data->off_price;
          $details=$row_short_course_data->details;
        } 
      ?>      
...
<script>
    $('#short_course_edit').submit(function(e) {
        e.preventDefault();

        $.ajax({
            url: '<?= site_url(); ?>admin/Short_Course/update',
            type: 'POST',
            ...
            success: function(data) {
                ...
                window.location.href = '<?php echo base_url() . "admin/short_course"; ?>';
            },
            error: function(data) {
