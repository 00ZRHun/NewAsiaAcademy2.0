...
?>
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              <div class="x_title">
                <h2>Workshop/Short Course List</h2>
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <button type="button" class="btn btn-success"> <a style="color: white" href="<?= site_url(); ?>admin/short_course/add" >Add New</a></button>
                </ul>
                      ...
                      <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php foreach($short_course_list as $row_short_course){ ?>
                            <tr id="<?php echo $row_short_course->ID;?>"> 
                              <td><?php echo $row_short_course->ID; ?></td>
                              <td><?php echo $row_short_course->title;?></td>
                              <td>
                                <img id="myImg" onclick="onClick(this)" style="max-width: 100px;max-width: 56.25px;" src="../images/<?php echo $row_short_course->image;?>" >
                              </td>
                              <td><?php echo $row_short_course->ori_price;?></td>
                              <td><?php echo $row_short_course->off_price;?></td>
                              <td>
                                <!-- <a href="../images/<?php echo $row_short_course->details;?>"> -->
                                <!-- <button type="button" class="btn btn-success" style="font-size: 10px" data-toggle="modal" onclick="open_modal(<?php echo $row_short_course->details; ?>)">VIEW</button> -->
                                <button type="button" class="btn btn-success" style="font-size: 10px" data-toggle="modal" onclick="open_modal('<?php echo $row_short_course->details; ?>')">VIEW</button>
                              <!-- </a> -->
                              </td>
                              <td>
                                <a href="<?php echo base_url('admin/Short_Course/edit/'.$row_short_course->ID) ?>">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <!-- <iframe class="embed-responsive-item" id="modalFrame" src="http://localhost:8080/newasia/images/6ffc2e70bf167e9247cdc82aaad2b317.pdf" allowfullscreen style="width: 100%;height:400px"></iframe> -->
...
<script>
  /* function open_modal(id){
    ...
    $.ajax({
      url: address + "Short_Course/display_modal",
      method: "POST",
      data: {id:id},
      dataType: "json",
...
<script type="text/javascript">
  $(".remove").click(function(){
    ...
    {
      $.ajax({
        url: '<?php echo site_url("admin/Short_Course/delete/");?>',
        type: 'POST',
        data:({id:id}),
