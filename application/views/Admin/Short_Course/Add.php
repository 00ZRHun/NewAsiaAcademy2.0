...
?>
    ...
    <div class="right_col" role="main">   
      <div class="x_title">
        <h2>Workshop/Short Course > Add New</h2>
      ...
      <form method="POST" id="short_course_add" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    ...
    <script>
      $('#short_course_add').submit(function(e) {
          e.preventDefault();

          $.ajax({
              url: '<?= site_url(); ?>admin/short_course/add_course',
              type: 'POST',
