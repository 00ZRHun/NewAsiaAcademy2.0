...
?>
    ...
    <div class="right_col" role="main">   
      <div class="x_title">
        <h2>Professional Course > Add New</h2>
      ...
      <form method="POST" id="professional_course_add" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    ...
    <script>
      $('#professional_course_add').submit(function(e) {
          e.preventDefault();

          $.ajax({
              url: '<?= site_url(); ?>admin/professional_course/add_course',
              type: 'POST',
