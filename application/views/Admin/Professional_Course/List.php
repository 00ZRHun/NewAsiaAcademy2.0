...
?>
        ...
        <div class="right_col" role="main">
          <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
              <div class="x_title">
                <h2>Professional Course List</h2>
                <ul class="nav navbar-right panel_toolbox">
                  ...
                  <button type="button" class="btn btn-success"> <a style="color: white" href="<?= site_url(); ?>admin/professional_course/add" >Add New</a></button>
                </ul>
                      ...
                      <table id="datatable-fixed-header" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php foreach($professional_course_list as $row_professional_course){ ?>
                            <tr id="<?php echo $row_professional_course->ID;?>"> 
                              <td><?php echo $row_professional_course->ID; ?></td>
                              <td><?php echo $row_professional_course->title;?></td>
                              <td>
                                <img id="myImg" onclick="onClick(this)" style="max-width: 100px;max-width: 56.25px;" src="../images/<?php echo $row_professional_course->image;?>" >
                              </td>
                              <td>1</td>
                              <td>1</td>
                              <td>
                                <!-- <a href="../images/<?php echo $row_professional_course->details;?>"> -->
                                <!-- <button type="button" class="btn btn-success" style="font-size: 10px" data-toggle="modal" onclick="open_modal(<?php echo $row_professional_course->details; ?>)">VIEW</button> -->
                                <button type="button" class="btn btn-success" style="font-size: 10px" data-toggle="modal" onclick="open_modal('<?php echo $row_professional_course->details; ?>')">VIEW</button>
                              <!-- </a> -->
                              </td>
                              <td>
                                <a href="<?php echo base_url('admin/Professional_Course/edit/'.$row_professional_course->ID) ?>">
...
<script>
  /* function open_modal(id){
    ...
    $.ajax({
      url: address + "Professional_Course/display_modal",
      method: "POST",
      data: {id:id},
      dataType: "json",
...
<script type="text/javascript">
  $(".remove").click(function(){
    ...
    {
      $.ajax({
        url: '<?php echo site_url("admin/Professional_Course/delete/");?>',
        type: 'POST',
        data:({id:id}),
